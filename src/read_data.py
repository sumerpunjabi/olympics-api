        ...
        with open(file, mode='r') as csv_file:
            ...
            for row in csv_reader:
                ...
                try:
                    ...
                    athlete_query = "INSERT INTO athletes (name, sex, age, country_id) " \
                                    "VALUES (%s, %s, %s, (SELECT id FROM countries WHERE code = %s))"
                    ...
                    event_query = "INSERT INTO events (name, sport_id) " \
                                  "VALUES (%s, (SELECT id FROM sports WHERE name = %s))"
                    ...
                    medal_query = "INSERT INTO medals (athlete_id, event_id, medal, game_id) " \
                                  "VALUES ((SELECT id FROM athletes WHERE name = %s), " \
                                  "(SELECT id FROM events WHERE name = %s), %s, " \
                                  "(SELECT id FROM games WHERE year = %s AND season = %s AND city = %s))"
